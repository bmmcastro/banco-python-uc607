...
#o if é obrigatório no Windows: os processos do relatório voltam a ler este
#ficheiro, e sem a proteção cada um deles tentava arrancar o programa outra vez
